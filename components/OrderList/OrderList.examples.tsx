...
export function OrderListUtilsExample() {
  ...
  const canCancelFirst = OrderListUtils.canCancel(mockOrders[0]);
  const canRefundSecond = OrderListUtils.canRefund(mockOrders[1]);
  const totalItems = OrderListUtils.getTotalItems(mockOrders[0]);
