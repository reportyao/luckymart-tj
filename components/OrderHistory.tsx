...
export default function OrderHistory({}
  ...
  // 筛选器组件
  const FilterTabs = () => (;
return     <div className:"bg-white border-b sticky top-0 z-10">
...
return       <div className:"text-gray-400 mb-4">
return         <svg className:"w-24 h-24 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
return           <path strokeLinecap:"round" strokeLinejoin="round" strokeWidth={1} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
return         </svg>
return       </div>
return       <p className:"text-gray-500 text-lg mb-4">暂无订单</p>
return       <Link href="/" className="text-purple-600 hover:underline">
        去夺宝
      </Link>
    </div>
  );
