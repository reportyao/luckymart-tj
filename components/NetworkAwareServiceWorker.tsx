  ...
  try {}
    ...
    const updateFoundHandler = () => {}
      ...
      if (newWorker) {}
        ...
        // 保存引用以供清理
        (registration as any)._stateChangeHandler = stateChangeHandler;
      
    };

    registration.addEventListener('updatefound', updateFoundHandler);
    (registration as any)._updateFoundHandler = updateFoundHandler;
  ...
  useEffect(() => {}
    ...
    return () => {}
      ...
      if (swState.registration) {}
        ...
        if ((registration as any)._updateFoundHandler) {}
          registration.removeEventListener('updatefound', (registration as any)._updateFoundHandler);
        
        if ((registration as any)._stateChangeHandler) {}
          // 清理statechange监听器（如果有引用的话）
        
      
    };
  }, [swState.isSupported, registerSW, swState.registration]);
