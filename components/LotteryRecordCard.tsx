    ...
    <div className={cardClasses}>
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
          <div>
            <p className="text-gray-500">{t('lottery.records.shares', '股数')}</p>
            <p className="font-medium text-gray-900">{record.sharesCount}</p>
          </div>
          <div>
            <p className="text-gray-500">{t('lottery.records.cost', '消费')}</p>
